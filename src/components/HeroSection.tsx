      ...
      >
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-sm font-medium tracking-widest uppercase text-accent">
            Precision RF Shielding
          </span>
        </div>

        <h1 className="font-display text-4xl md:text-6xl font-bold text-primary-foreground leading-tight mb-6">
          Engineered RF Cages for{" "}
          <span className="text-gradient">MRI Excellence</span>
        </h1>

        <p className="text-lg md:text-xl text-primary-foreground/75 mb-10 max-w-xl leading-relaxed">
          Industry-leading electromagnetic shielding solutions designed for
          optimal MRI performance, patient safety, and regulatory compliance.
        </p>
