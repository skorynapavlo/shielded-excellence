...
export const translations = {
  ...
  uk: {
    ...
    products: {
      ...
      title: "Наш асортимент продукції",
      description:
        "Кожне рішення спроектовано з високою точністю для відповідності найвимогливішим стандартам електромагнітного екранування в сучасних МРТ-середовищах.",
      items: [
        {
          title: "РЧ-екрановані вікна",
          description:
            "Багатошарові ламіновані РЧ-екрановані вікна з мідною сіткою, що забезпечують чітку видимість у МРТ-кімнату без компромісу в електромагнітній цілісності.",
        ...
        },
        {
          ...
          specs: ["Сумісність 1.5T – 7T", "Комплексна поставка", "Відповідність IEC 61000"],
        },
        {
    ...
    capabilities: {
      ...
      description:
        "Десятиліття досвіду в електромагнітному екрануванні, підкріплені передовим виробництвом та суворим контролем якості.",
      items: [
        { title: "120+ дБ ослаблення", desc: "Перевищення міжнародних стандартів екранування на всіх частотах МРТ." },
        { title: "Індивідуальне проектування", desc: "Кожна камера адаптована до точних розмірів та вимог вашого об'єкта." },
    ...
    contact: {
      ...
      description:
        "Чи потрібна вам пропозиція на індивідуальний корпус, чи технічна консультація — наша інженерна команда готова допомогти.",
      phone: "+1 (555) 012-3456",
      email: "info@shieldrf.com",
      address: "1200 Industrial Pkwy, Suite 300, Denver, CO 80202",
      nameLabel: "Ім'я",
    ...
    footer: {
      tagline: "Точне РЧ-екранування для систем МРТ",
    },
  },
} as const;
