    ...
    products: {
      ...
      items: [
        ...
        },
        {
          ...
          projects: [
            { name: "ProHealth", location: "Ternopil, Ukraine", mriManufacturer: "siemens" },
            { name: "Oxford Medical", location: "Kyiv, Ukraine", mriManufacturer: "ge" },
            { name: "Sumy Regional Clinical Hospital", location: "Sumy, Ukraine", mriManufacturer: "siemens" },
            { name: "Main Military Medical Clinical Center of the State Border Guard Service of Ukraine", location: "Kyiv, Ukraine", mriManufacturer: "fujifilm" },
            { name: "Hospital of Saint Luke", location: "Lviv, Ukraine", mriManufacturer: "philips" },
          ],
        },
        {
    ...
    products: {
      ...
      items: [
        ...
        },
        {
          ...
          projects: [
            { name: "ПроХелс", location: "Тернопіль, Україна", mriManufacturer: "siemens" },
            { name: "Оксфорд Медікал", location: "Київ, Україна", mriManufacturer: "ge" },
            { name: "Сумська обласна клінічна лікарня", location: "Суми, Україна", mriManufacturer: "siemens" },
            { name: "Головний військово-медичний клінічний центр Державної прикордонної служби України", location: "Київ, Україна", mriManufacturer: "fujifilm" },
            { name: "Лікарня Святого Луки", location: "Львів, Україна", mriManufacturer: "philips" },
          ],
        },
        {
